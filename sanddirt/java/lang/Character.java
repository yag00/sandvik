...
public final class Character implements java.io.Serializable, Comparable<Character> {
    ...
    public static final class UnicodeBlock extends Subset {
        ...
        public static final UnicodeBlock ARABIC_EXTENDED_A =
            new UnicodeBlock("ARABIC_EXTENDED_A", "ARABIC EXTENDED-A", "ARABICEXTENDED-A");
        ...
        public static final UnicodeBlock SUNDANESE_SUPPLEMENT =
            new UnicodeBlock("SUNDANESE_SUPPLEMENT", "SUNDANESE SUPPLEMENT", "SUNDANESESUPPLEMENT");
        ...
        public static final UnicodeBlock MEROITIC_HIEROGLYPHS =
            new UnicodeBlock("MEROITIC_HIEROGLYPHS", "MEROITIC HIEROGLYPHS", "MEROITICHIEROGLYPHS");
        ...
        public static final UnicodeBlock MEROITIC_CURSIVE =
            new UnicodeBlock("MEROITIC_CURSIVE", "MEROITIC CURSIVE", "MEROITICCURSIVE");
        ...
        public static final UnicodeBlock SORA_SOMPENG =
            new UnicodeBlock("SORA_SOMPENG", "SORA SOMPENG", "SORASOMPENG");
    ...
    public static enum UnicodeScript {
        ...
        private static final UnicodeScript[] scripts = {COMMON,
                                                        LATIN,
                                                        COMMON,
                                                        LATIN,
                                                        COMMON,
     ...
     * {@link #toCodePoint toCodePoint}{@code (highSurrogate(x), }{@link #lowSurrogate
     * lowSurrogate}{@code (x)) == x} are also always {@code true}.
     *
     ...
     * {@link #toCodePoint toCodePoint}{@code (}{@link #highSurrogate highSurrogate}{@code (x),
     * lowSurrogate(x)) == x} are also always {@code true}.
     *
     * @param   codePoint a supplementary character (Unicode code point)
     ...
     * @since   1.5
     */
    public native static boolean isLowerCase(int codePoint);
     ...
     * @since   1.5
     */
    public native static boolean isUpperCase(int codePoint);
    ...
    public static boolean isAlphabetic(int codePoint) {
        return (((((1 << Character.UPPERCASE_LETTER) | (1 << Character.LOWERCASE_LETTER)
                   | (1 << Character.TITLECASE_LETTER) | (1 << Character.MODIFIER_LETTER)
                   | (1 << Character.OTHER_LETTER) | (1 << Character.LETTER_NUMBER))
                  >> getType(codePoint))
                 & 1)
                != 0)
    ...
    public static boolean isSpace(char ch) {
        return (ch <= 0x0020)
            && (((((1L << 0x0009) | (1L << 0x000A) | (1L << 0x000C) | (1L << 0x000D)
                   | (1L << 0x0020))
                  >> ch)
                 & 1L)
                != 0);
     ...
     * @since 1.5
     */
    public static char reverseBytes(char ch) { return (char) (((ch & 0xFF00) >> 8) | (ch << 8)); }
     ...
     * @since 1.7
     */
    public native static String getName(int codePoint);
}
