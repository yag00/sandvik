...
class CharacterData00 extends CharacterData {
    ...
    boolean isJavaIdentifierStart(int ch) {
        ...
        if (ch == 0x32FF || (ch >= 0x20BB && ch <= 0x20BF) || (ch >= 0x9FCD && ch <= 0x9FEF))
            return false;
        int props = getProperties(ch);
    ...
    // /scratch/8u_jenkins/workspace/8-2-build-olinux-x64-sans-NAS/jdk8u44/68/jdk/make/data/characterdata/CharacterData00.java.template
    // -spec
    ...
    // -o
    // /scratch/8u_jenkins/workspace/8-2-build-olinux-x64-sans-NAS/jdk8u44/68/build/linux-x64/jdk/gensrc/java/lang/CharacterData00.java
