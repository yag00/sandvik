// This file was generated AUTOMATICALLY from a template file Wed May 22 18:33:39 GMT 2024
/*
...
class CharacterData02 extends CharacterData {
    ...
    boolean isWhitespace(int ch) { return (getProperties(ch) & 0x00007000) == 0x00004000; }
    ...
    boolean isMirrored(int ch) { return (getProperties(ch) & 0x80000000) != 0; }
    ...
    // /scratch/8u_jenkins/workspace/8-2-build-olinux-x64-sans-NAS/jdk8u44/68/jdk/make/data/characterdata/CharacterData02.java.template
    // -spec
    // /scratch/8u_jenkins/workspace/8-2-build-olinux-x64-sans-NAS/jdk8u44/68/jdk/make/data/unicodedata/UnicodeData.txt
    // -specialcasing
    // /scratch/8u_jenkins/workspace/8-2-build-olinux-x64-sans-NAS/jdk8u44/68/jdk/make/data/unicodedata/SpecialCasing.txt
    // -proplist
    // /scratch/8u_jenkins/workspace/8-2-build-olinux-x64-sans-NAS/jdk8u44/68/jdk/make/data/unicodedata/PropList.txt
    // -o
    // /scratch/8u_jenkins/workspace/8-2-build-olinux-x64-sans-NAS/jdk8u44/68/build/linux-x64/jdk/gensrc/java/lang/CharacterData02.java
    // -string -usecharforbyte 11 4 1 The X table has 2048 entries for a total of 4096 bytes.
    ...
    static final char Y[] =
        ("\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000"
         ...
         + "\000\000\000\000\000\000\010\000\000\000\000\000\000\000")
            .toCharArray();
    ...
    static final char B[] = ("\020\020\020\000\000\000\000\000\020\020").toCharArray();
