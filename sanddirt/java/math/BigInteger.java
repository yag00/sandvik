...
public class BigInteger extends Number implements Comparable<BigInteger> {
    ...
    private static long bitsPerDigit[] = {
        0,    0,    1024, 1624, 2048, 2378, 2648, 2875, 3072, 3247, 3402, 3543, 3672,
    ...
    private static int[] subtract(int[] big, long val) {
        ...
        if (highWord == 0) {
            ...
            result[bigIndex] = (int) difference;
            difference =
                (big[--bigIndex] & LONG_MASK) - (highWord & LONG_MASK) + (difference >> 32);
            result[bigIndex] = (int) difference;
        }
     ...
     */
    static int bitLengthForInt(int n) { return 32 - Integer.numberOfLeadingZeros(n); }
     ...
     */
    public BigInteger abs() { return (signum >= 0 ? this : this.negate()); }
     ...
     *         {@code val}.  If they are equal, either may be returned.
     */
    public BigInteger max(BigInteger val) { return (compareTo(val) > 0 ? this : val); }
     ...
     * used.
     */
    private static int digitsPerLong[] = {0,  0,  62, 39, 31, 27, 24, 22, 20, 19, 18, 18, 17,
     ...
     */
    private static int digitsPerInt[] = {0, 0, 30, 19, 15, 13, 11, 11, 10, 9, 9, 8, 8,
                                         8, 8, 7,  7,  7,  7,  7,  7,  7,  6, 6, 6, 6,
                                         6, 6, 6,  6,  6,  6,  6,  6,  6,  6, 5};

    private static int intRadix[] = {
        0,          0,          0x40000000, 0x4546b3db, 0x40000000, 0x48c27395, 0x159fd800,
        0x75db9c97, 0x40000000, 0x17179149, 0x3b9aca00, 0xcc6db61,  0x19a10000, 0x309f1021,
        0x57f6c100, 0xa2f1b6f,  0x10000000, 0x18754571, 0x247dbc80, 0x3547667b, 0x4c4b4000,
        0x6b5a6e1d, 0x6c20a40,  0x8d2d931,  0xb640000,  0xe8d4a51,  0x1269ae40, 0x17179149,
    ...
    private static class UnsafeHolder {
        static native void putSign(BigInteger bi, int sign);
        static native void putMag(BigInteger bi, int[] magnitude);
    }
