...
public final class Spliterators {
    ...
    public static Spliterator.OfDouble spliterator(PrimitiveIterator.OfDouble iterator,
                                                   long size,
                                                   int characteristics) {
        return new DoubleIteratorSpliterator(
            Objects.requireNonNull(iterator), size, characteristics);
    }
    ...
    private static abstract class EmptySpliterator<T, S extends Spliterator<T>, C> {
        ...
        public void forEachRemaining(C consumer) { Objects.requireNonNull(consumer); }
