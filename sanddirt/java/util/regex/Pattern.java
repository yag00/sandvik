 ...
 * character with hexadecimal&nbsp;value&nbsp;<tt>0x</tt><i>h...h</i>
 ...
 * (negation)</td></tr> <tr><td valign="top" headers="construct classes">{@code [a-zA-Z]}</td> <td
 * headers="matches">{@code a} through {@code z} or {@code A} through {@code Z}, inclusive
 * (range)</td></tr> <tr><td valign="top" headers="construct classes">{@code [a-d[m-p]]}</td> <td
 * headers="matches">{@code a} through {@code d}, or {@code m} through {@code p}: {@code [a-dm-p]}
 * (union)</td></tr> <tr><td valign="top" headers="construct classes">{@code [a-z&&[def]]}</td> <td
 * headers="matches">{@code d}, {@code e}, or {@code f} (intersection)</tr> <tr><td valign="top"
 * headers="construct classes">{@code [a-z&&[^bc]]}</td> <td headers="matches">{@code a} through
 * {@code z}, except for {@code b} and {@code c}: {@code [ad-z]} (subtraction)</td></tr> <tr><td
 * valign="top" headers="construct classes">{@code [a-z&&[^m-p]]}</td> <td headers="matches">{@code
 * a} through {@code z}, and not {@code m} through {@code p}: {@code
 * [a-lq-z]}(subtraction)</td></tr> <tr><th>&nbsp;</th></tr>
 *
 * <tr align="left"><th colspan="2" id="predef">Predefined character classes</th></tr>
 *
 * <tr><td valign="top" headers="construct predef"><tt>.</tt></td>
 *     <td headers="matches">Any character (may or may not match <a href="#lt">line
 * terminators</a>)</td></tr> <tr><td valign="top" headers="construct predef"><tt>\d</tt></td> <td
 * headers="matches">A digit: <tt>[0-9]</tt></td></tr> <tr><td valign="top" headers="construct
 * predef"><tt>\D</tt></td> <td headers="matches">A non-digit: <tt>[^0-9]</tt></td></tr> <tr><td
 * valign="top" headers="construct predef"><tt>\h</tt></td> <td headers="matches">A horizontal
 * whitespace character: <tt>[
 ...
 * <tr><th>&nbsp;</th></tr>
 * <tr align="left"><th colspan="2" id="posix"><b>POSIX character classes (US-ASCII
 * only)</b></th></tr>
 *
 ...
 *
 * <tr><th>&nbsp;</th></tr>
 * <tr align="left"><th colspan="2">java.lang.Character classes (simple <a href="#jcc">java
 * character type</a>)</th></tr>
 *
 ...
 *
 * <tr><th>&nbsp;</th></tr>
 * <tr align="left"><th colspan="2" id="unicode">Classes for Unicode scripts, blocks, categories and
 * binary properties</th></tr> <tr><td valign="top" headers="construct unicode">{@code
 * \p{IsLatin}}</td> <td headers="matches">A Latin&nbsp;script character (<a
 * href="#usc">script</a>)</td></tr> <tr><td valign="top" headers="construct unicode">{@code
 * \p{InGreek}}</td> <td headers="matches">A character in the Greek&nbsp;block (<a
 ...
 * greedy"><i>X</i><tt>{</tt><i>n</i><tt>,</tt><i>m</i><tt>}</tt></td> <td
 ...
 *     <td headers="matches"><i>X</i>, at least <i>n</i> times</td></tr>
 * <tr><td valign="top" headers="construct
 * reluc"><i>X</i><tt>{</tt><i>n</i><tt>,</tt><i>m</i><tt>}?</tt></td> <td
 * headers="matches"><i>X</i>, at least <i>n</i> but not more than <i>m</i> times</td></tr>
 *
 * <tr><th>&nbsp;</th></tr>
 ...
 *     <td headers="matches"><i>X</i>, at least <i>n</i> times</td></tr>
 * <tr><td valign="top" headers="construct
 * poss"><i>X</i><tt>{</tt><i>n</i><tt>,</tt><i>m</i><tt>}+</tt></td> <td
 * headers="matches"><i>X</i>, at least <i>n</i> but not more than <i>m</i> times</td></tr>
 *
 * <tr><th>&nbsp;</th></tr>
 ...
 *
 * <tr><th>&nbsp;</th></tr>
 * <tr align="left"><th colspan="2" id="special">Special constructs (named-capturing and
 * non-capturing)</th></tr>
 *
 * <tr><td valign="top" headers="construct special"><tt>(?&lt;<a
 * href="#groupname">name</a>&gt;</tt><i>X</i><tt>)</tt></td> <td headers="matches"><i>X</i>, as a
 * named-capturing group</td></tr> <tr><td valign="top" headers="construct
 * special"><tt>(?:</tt><i>X</i><tt>)</tt></td> <td headers="matches"><i>X</i>, as a non-capturing
 * group</td></tr> <tr><td valign="top" headers="construct
...
public final class Pattern implements java.io.Serializable {
    ...
    private native int getClass(int c);
     ...
     */
    private boolean has(int f) { return (flags & f) != 0; }
        ...
        if (ch == '?') {
            ...
            switch (ch) {
                ...
                case '<': // (?<xxx)  look behind
                    ...
                    if (ch == '=') {
                        head = tail =
                            (hasSupplementary ? new BehindS(head, info.maxLength, info.minLength)
    ...
    private void setcursor(int pos) { cursor = pos; }
    ...
    private static final class BitClass extends BmpCharProperty {
        ...
        boolean isSatisfiedBy(int ch) { return ch < 256 && bits[ch]; }
    }
    ...
    static final class Dollar extends Node {
        boolean multiline;
        Dollar(boolean mul) { multiline = mul; }
        boolean match(Matcher matcher, int i, CharSequence seq) {
            int endIndex = (matcher.anchoringBounds) ? matcher.to : matcher.getTextLength();
            if (!multiline) {
                if (i < endIndex - 2)
    ...
    static final class UnixDollar extends Node {
        boolean multiline;
        UnixDollar(boolean mul) { multiline = mul; }
        boolean match(Matcher matcher, int i, CharSequence seq) {
            int endIndex = (matcher.anchoringBounds) ? matcher.to : matcher.getTextLength();
            if (i < endIndex) {
                char ch = seq.charAt(i);
    ...
    static final class SingleS extends CharProperty {
        ...
        boolean isSatisfiedBy(int ch) { return ch == c; }
    }
    ...
    static final class SingleI extends BmpCharProperty {
        ...
        boolean isSatisfiedBy(int ch) { return ch == lower || ch == upper; }
    }
    ...
    static final class SingleU extends CharProperty {
        final int lower;
        SingleU(int lower) { this.lower = lower; }
        boolean isSatisfiedBy(int ch) {
    ...
    static final class Block extends CharProperty {
        final Character.UnicodeBlock block;
        Block(Character.UnicodeBlock block) { this.block = block; }
        boolean isSatisfiedBy(int ch) { return block == Character.UnicodeBlock.of(ch); }
    }
    ...
    static final class Script extends CharProperty {
        final Character.UnicodeScript script;
        Script(Character.UnicodeScript script) { this.script = script; }
        boolean isSatisfiedBy(int ch) { return script == Character.UnicodeScript.of(ch); }
    }
    ...
    static final class Category extends CharProperty {
        ...
        boolean isSatisfiedBy(int ch) { return (typeMask & (1 << Character.getType(ch))) != 0; }
    }
    ...
    static final class Utype extends CharProperty {
        ...
        boolean isSatisfiedBy(int ch) { return uprop.is(ch); }
    }
    ...
    static class SliceIS extends SliceNode {
        SliceIS(int[] buf) { super(buf); }
        int toLower(int c) { return ASCII.toLower(c); }
        boolean match(Matcher matcher, int i, CharSequence seq) {
            int[] buf = buffer;
            int x = i;
            for (int j = 0; j < buf.length; j++) {
    ...
    static final class SliceUS extends SliceIS {
        SliceUS(int[] buf) { super(buf); }
        int toLower(int c) { return Character.toLowerCase(Character.toUpperCase(c)); }
    }
    ...
    static final class All extends CharProperty {
        boolean isSatisfiedBy(int ch) { return true; }
    }
    ...
    static final class BranchConn extends Node {
        ...
        boolean study(TreeInfo info) { return info.deterministic; }
    }
    ...
    static final class GroupHead extends Node {
        int localIndex;
        GroupHead(int localCount) { localIndex = localCount; }
        boolean match(Matcher matcher, int i, CharSequence seq) {
    ...
    static final class First extends Node {
        Node atom;
        First(Node node) { this.atom = BnM.optimize(node); }
        boolean match(Matcher matcher, int i, CharSequence seq) {
    ...
    static final class BehindS extends Behind {
        BehindS(Node cond, int rmax, int rmin) { super(cond, rmax, rmin); }
        boolean match(Matcher matcher, int i, CharSequence seq) {
            ...
            for (int j = i - rminChars; !conditionMatched && j >= from;
    ...
    static final class NotBehindS extends NotBehind {
        NotBehindS(Node cond, int rmax, int rmin) { super(cond, rmax, rmin); }
        boolean match(Matcher matcher, int i, CharSequence seq) {
            int rmaxChars = countChars(seq, i, -rmax);
            int rminChars = countChars(seq, i, -rmin);
            int savedFrom = matcher.from;
    ...
    static final class BnMS extends BnM {
        ...
        NEXT:
            while (i <= last) {
                // Loop over pattern from right to left
                int ch;
                for (int j = countChars(seq, i, patternLength), x = patternLength - 1; j > 0;
    ...
    private static class CharPropertyNames {
        ...
        static {
            ...
            defCategory("N",
                        ((1 << Character.DECIMAL_DIGIT_NUMBER) | (1 << Character.LETTER_NUMBER)
                         | (1 << Character.OTHER_NUMBER)));
            defCategory("Z",
                        ((1 << Character.SPACE_SEPARATOR) | (1 << Character.LINE_SEPARATOR)
            ...
            defCategory("S",
                        ((1 << Character.MATH_SYMBOL) | (1 << Character.CURRENCY_SYMBOL)
    ...
    public Stream<String> splitAsStream(final CharSequence input) {
        class MatcherIterator implements Iterator<String> {
            ...
            MatcherIterator() { this.matcher = matcher(input); }
