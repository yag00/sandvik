...
public final class Matcher implements MatchResult {
     ...
     */
    public Pattern pattern() { return parentPattern; }
     ...
     * @since 1.8
     */
    public int start(String name) { return groups[getMatchedGroupIndex(name) * 2]; }
     ...
     * @since 1.8
     */
    public int end(String name) { return groups[getMatchedGroupIndex(name) * 2 + 1]; }
     ...
     */
    public int groupCount() { return parentPattern.capturingGroupCount - 1; }
     ...
     * @since 1.5
     */
    public boolean hitEnd() { return hitEnd; }
     ...
     * @since 1.5
     */
    public boolean requireEnd() { return requireEnd; }
     ...
     */
    char charAt(int i) { return text.charAt(i); }
